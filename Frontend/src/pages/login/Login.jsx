    ...
    return (
      <main>
        ...
        <form action="" className="d-flex flex-column gap-2">
            <label htmlFor="" className="fst-italic align-self-start">Documento de identidad / Pasaporte</label>
            <input type="text" className="bg-light border border-none text-dark p-2 mb-3" placeholder="Documento de identidad / Pasaporte" required/>
            
            <label htmlFor="" className="fst-italic align-self-start">Contraseña</label>
